...
function NewsLetter() {
  ...
  return (
    <div className="min-h-screen md:py-16 py-5 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/10 shadow-2xl">
              ...
              <div className="space-y-4">
                {features.map((f, i) => (
                  ...
                  >
                    <div
                      className={`w-15 max-w-10  h-12 flex items-center justify-center bg-gradient-to-br ${f.color} rounded-xl`}
                    >
