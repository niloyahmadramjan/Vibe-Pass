...
function UpcomingEvent() {
  ...
  return (
    <div className="min-h-screen md:py-10 px-4 sm:px-6 lg:px-8">
...
const EventModal = ({ event, onClose }) => (
  <motion.div
    ...
    animate={{ opacity: 1 }}
    exit={{ opacity: 0 }}
    className="fixed inset-0 bg-black/80 pt-20 backdrop-blur-sm z-50 flex items-center justify-center p-4"
    onClick={onClose}
  >
    <motion.div
