...
export default function AdminChat({ isOpen, onClose }) {
  ...
  }, [loadMessages, connectionStatus, user?._id, isOpen])
            ...
            <div className="space-y-3">
              {messages.map((message) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`max-w-[85%] px-3 py-2 rounded-xl text-xs shadow-lg transition-all duration-200 break-words ${
                        isMine
                        ...
                        isTemp
                          ? 'opacity-70 border border-dashed border-yellow-400/50'
                          : ''
                      }`}
                    >
