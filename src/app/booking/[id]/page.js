        ...
        <div className="text-center mb-10">
          ...
          <div className="mt-6 w-full bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800 rounded-2xl p-6 border border-red-500/30 shadow-2xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              {/* Date */}
              <div className={`rounded-lg p-4 border transition-all ${selectedDate ? 'bg-red-500/10 border-red-500/50' : 'bg-gray-800/50 border-gray-700/50'}`}>
                ...
                <p className={`font-bold text-sm ${selectedDate ? 'text-red-400' : 'text-white'}`}>
                  {selectedDate ? new Date(selectedDate).toLocaleDateString('en-GB') : 'Not Selected'}
                </p>
              </div>
              
              {/* Showtime */}
              <div className={`rounded-lg p-4 border transition-all ${selectedTime ? 'bg-red-500/10 border-red-500/50' : 'bg-gray-800/50 border-gray-700/50'}`}>
              ...
              {/* Seats */}
              <div className={`rounded-lg p-4 border transition-all ${selectedSeats.length > 0 ? 'bg-red-500/10 border-red-500/50' : 'bg-gray-800/50 border-gray-700/50'}`}>
              ...
              <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/50">
                ...
                <p className="font-bold text-green-400 text-lg">৳{totalPrice}</p>
              </div>
            </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-700/50">
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  {selectedSeats.map((seat) => (
                    <span key={seat} className="px-3 py-1 bg-red-500/20 text-red-400 rounded-full text-sm font-semibold border border-red-500/40">
                      {seat}
                    </span>
                  ))}
                </div>
