        ...
        <section className="text-white py-16 px-6 md:px-20">
            ...
            >
                ...
                <p className="text-gray-300">
                    ...
                    select seats, and book tickets instantly – all from the comfort of your home.
                </p>
            </motion.div>
                    ...
                    {teamMembers.map((member, i) => (
                        ...
                        >
                            <img
                                src={member.photo}
                                alt={member.name}
                                className="w-28 h-28 mx-auto rounded-full border-4 border-red-500 object-cover mb-4"
                            />
            ...
            >
                ...
                <p className="text-gray-300 max-w-2xl mx-auto mb-10">
                    Explore the key features that make <span className="text-red-400 font-semibold">Vibe Pass </span>
